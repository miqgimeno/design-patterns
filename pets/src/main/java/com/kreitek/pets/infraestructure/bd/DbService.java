...
public class DbService {
    ...
    public void addNewDog(Dog dog) {
        ...
        System.out.println(logger.debug("BdService.Dog added"));
    }
    public void addNewCat(Cat cat) {
        cats.add(cat);
        // TODO logger.debug("BdService.Cat added");
        System.out.println(logger.debug("BdService.Cat added"));
    }

    public List<Cat> getCats() {
        // TODO logger.debug("BdService.Get " + cats.size() + cats);
        System.out.println(logger.debug("BdService.Get " + cats.size() + cats));
        return new ArrayList<>(cats);
    }

    public List<Dog> getDogs() {
        // TODO logger.debug("BdService.Get " + cats.size() + dogs);
        System.out.println(logger.debug("BdService.Get " + cats.size() + dogs));
